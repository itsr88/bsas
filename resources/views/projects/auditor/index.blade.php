                    ...
                    <thead>
                        ...
                        @foreach ($projects as $project)
                            <tr id="{{$project->id}}">
                                ...
                                <td data-name="akt_priemki_SP_E1_R1_data" class=""><div>{{$project->akt_priemki_SP_E1_R1_data}}</div></td>
                                <td data-name="akt_priemki_SP_E1_R1_data_kommentarii" class=""><div>{{$project->akt_priemki_SP_E1_R1_data_kommentarii}}</div></td>
                                <td data-name="oplata_SP_E1_R1_obshchaia_summa_zakaza_NDS" class=""><div>{{$project->oplata_SP_E1_R1_obshchaia_summa_zakaza_NDS}}</div></td>
                                <td data-name="oplata_SP_E1_R1_avans" class=""><div>{{$project->oplata_SP_E1_R1_avans}}</div></td>
                                <td data-name="oplata_SP_E1_R1_data_kommentarii" class=""><div>{{$project->oplata_SP_E1_R1_data_kommentarii}}</div></td>
                                <td data-name="oplata_SP_E1_R1_post_oplata" class=""><div>{{$project->oplata_SP_E1_R1_post_oplata}}</div></td>
                                <td data-name="post_oplata_SP_E1_R1_data_kommentarii" class=""><div>{{$project->post_oplata_SP_E1_R1_data_kommentarii}}</div></td>
                                ...
                                <td data-name="akt_priemki_E2_R2_data" class=""><div>{{$project->akt_priemki_E2_R2_data}}</div></td>
                                ...
                                <td data-name="oplata_Е2_R2_avans" class=""><div>{{$project->oplata_Е2_R2_avans}}</div></td>
                                <td data-name="oplata_Е2_R2_data_kommentarii" class=""><div>{{$project->oplata_Е2_R2_data_kommentarii}}</div></td>
                                <td data-name="oplata_Е2_R2_post_oplata" class=""><div>{{$project->oplata_Е2_R2_post_oplata}}</div></td>
                                <td data-name="post_oplata_Е2_R2_data_kommentarii" class=""><div>{{$project->post_oplata_Е2_R2_data_kommentarii}}</div></td>
                            </tr>
                        @endforeach
