    ...
    <div class="col-md-12">
        ...
        @foreach ($projects as $project)
            <tr data-id="{{$project->id}}">
                ...
                <td data-name="id" class="edit"><div>{{$project->id}}</div><input value="{{$project->id}}"></td>
                <td data-name="du_id" class="edit"><div>{{$project->du_id}}</div><input value="{{$project->du_id}}"></td>
                <td data-name="podriadchik" class="edit"><div>{{$project->podriadchik}}</div><input value="{{$project->podriadchik}}"></td>
