    ...
    <div class="col-md-12">
        ...
        @foreach ($projects as $project)
            <tr id="{{$project->id}}">
                ...
                <td data-name="id" class="edit id">{{$project->id}}</td>
                ...
                <td data-name="PSEZ_gotov_proektirovshchik" class="edit"><div>{{$project->PSEZ_gotov_proektirovshchik}}</div></td>
                <td data-name="PSEZ_peredan_v_OI_planovaia_data" class="edit"><div>{{$project->PSEZ_peredan_v_OI_planovaia_data}}</div></td>
                <td data-name="PSEZ_peredan_v_OI_fakticheskaia_data" class="edit"><div>{{$project->PSEZ_peredan_v_OI_fakticheskaia_data}}</div></td>
                <td data-name="PSEZ_peredan_v_OI_data_kommentarii" class="edit"><div>{{$project->PSEZ_peredan_v_OI_data_kommentarii}}</div></td>
                <td data-name="ekspertnoe_zacliuchenie_polucheno_planovaia_data" class="edit"><div>{{$project->ekspertnoe_zacliuchenie_polucheno_planovaia_data}}</div></td>
                <td data-name="ekspertnoe_zacliuchenie_polucheno_fakticheskaia_data" class="edit"><div>{{$project->ekspertnoe_zacliuchenie_polucheno_fakticheskaia_data}}</div></td>
                <td data-name="ekspertnoe_zacliuchenie_polucheno_data_kommentarii" class="edit"><div>{{$project->ekspertnoe_zacliuchenie_polucheno_data_kommentarii}}</div></td>
                <td data-name="ekspertnoe_zacliuchenie_peredano_v_RPN_planovaia_data" class="edit"><div>{{$project->ekspertnoe_zacliuchenie_peredano_v_RPN_planovaia_data}}</div></td>
                <td data-name="ekspertnoe_zacliuchenie_peredano_v_RPN_fakticheskaia_data" class="edit"><div>{{$project->ekspertnoe_zacliuchenie_peredano_v_RPN_fakticheskaia_data}}</div></td>
                <td data-name="ekspertnoe_zacliuchenie_peredano_v_RPN_data_kommentarii" class="edit"><div>{{$project->ekspertnoe_zacliuchenie_peredano_v_RPN_data_kommentarii}}</div></td>
                <td data-name="R1_gotov_planovaia_data" class="edit"><div>{{$project->R1_gotov_planovaia_data}}</div></td>
                <td data-name="R1_gotov_fakticheskaia_data" class="edit"><div>{{$project->R1_gotov_fakticheskaia_data}}</div></td>
                <td data-name="R1_gotov_data_kommentarii" class="edit"><div>{{$project->R1_gotov_data_kommentarii}}</div></td>
                ...
                <td data-name="zakaz_Р2_num" class="edit"><div>{{$project->zakaz_Р2_num}}</div></td>
                <td data-name="zakaz_R2_data_nachala" class="edit"><div>{{$project->zakaz_R2_data_nachala}}</div></td>
                <td data-name="zakaz_R2_data_okonchaniia_zakaza" class="edit"><div>{{$project->zakaz_R2_data_okonchaniia_zakaza}}</div></td>
                <td data-name="zakaz_R2_data_kommentarii" class="edit"><div>{{$project->zakaz_R2_data_kommentarii}}</div></td>
                <td data-name="zamery_EMI_planovaia_data" class="edit"><div>{{$project->zamery_EMI_planovaia_data}}</div></td>
                <td data-name="zamery_EMI_fakticheskaia_data" class="edit"><div>{{$project->zamery_EMI_fakticheskaia_data}}</div></td>
                <td data-name="zamery_EMI_kommentarii" class="edit"><div>{{$project->zamery_EMI_kommentarii}}</div></td>
                <td data-name="oformlenie_protokola_planovaia_data" class="edit"><div>{{$project->oformlenie_protokola_planovaia_data}}</div></td>
                <td data-name="oformlenie_protokola_fakticheskaia_data" class="edit"><div>{{$project->oformlenie_protokola_fakticheskaia_data}}</div></td>
                <td data-name="oformlenie_protokola_kommentarii" class="edit"><div>{{$project->oformlenie_protokola_kommentarii}}</div></td>
                <td data-name="ekspertiza_otpravlena_v_RPN_planovaia_data" class="edit"><div>{{$project->ekspertiza_otpravlena_v_RPN_planovaia_data}}</div></td>
                <td data-name="ekspertiza_otpravlena_v_RPN_fakticheskaia_data" class="edit"><div>{{$project->ekspertiza_otpravlena_v_RPN_fakticheskaia_data}}</div></td>
                <td data-name="ekspertiza_otpravlena_v_RPN__data_kommentarii" class="edit"><div>{{$project->ekspertiza_otpravlena_v_RPN__data_kommentarii}}</div></td>
                <td data-name="R2_gotov_planovaia_data" class="edit"><div>{{$project->R2_gotov_planovaia_data}}</div></td>
                <td data-name="R2_gotov_fakticheskaia_data" class="edit"><div>{{$project->R2_gotov_fakticheskaia_data}}</div></td>
                <td data-name="R2_gotov_data_kommentarii" class="edit"><div>{{$project->R2_gotov_data_kommentarii}}</div></td>
